...
"/" 		{ return new_symbol(sym.SPLIT, yytext()); }
...
"%=" 		{ return new_symbol(sym.REMND, yytext()); }
...
. { System.err.println("Nepoznat niz znakova: "+yytext()+" na liniji "+(yyline+1)+" i koloni "+yycolumn); }